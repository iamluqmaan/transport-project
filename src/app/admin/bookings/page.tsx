                      ...
                      <div className="space-y-1">
                          ...
                          <div className="text-xs text-gray-500 flex flex-col">
                              ...
                              {booking.emergencyContact && (
                                  <span className="text-gray-400 text-[10px]">Kin: {booking.emergencyContact}</span>
                              )}
                          </div>
                      </div>
                  ) : (
                ...
                <td className="p-4">
                    {booking.proofOfPayment ? (
                        ...
                        <div className="flex items-center gap-2">
                             ...
                             <a href={booking.proofOfPayment} download={`proof-${booking._id.toString().slice(-6)}.png`} className="block w-16 h-16 relative rounded overflow-hidden border hover:opacity-80 transition-opacity">
                                <Image 
                             ...
                             <a href={booking.proofOfPayment} download={`proof-${booking._id.toString().slice(-6)}.png`} className="text-xs text-blue-600 hover:underline">
                                 Download
                             </a>
                        </div>
                        )
